      ...
      <div>
        {PROJECTS.map((item,index)=>(
            <div key={index} className='mb-8 flex flex-wrap lg: justify-center'>
                <motion.div whileInView={{opacity:1,x:0}} initial={{opacity:0,x:-100}} className='w-full lg:w-1/4'>
                <img className='mb-6 rounded' src={item.image} width={170} height={170} alt="" />
                </motion.div>
